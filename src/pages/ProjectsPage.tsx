...
const ProjectsPage: React.FC = () => {
    ...
    <div className='main-container gap-y-12'>
        ...
        <ProjectContainer
            ...
            links={[
                {name: "Github", href:"https://github.com/DROP-TABLE-Druzyny/BiteHack"},
...
oraz przygotowanie API dla części frontendowej w Next.js.
        ...
        <ProjectContainer
            ...
            links={[
                {name: "Github", href:"https://github.com/Kaba8081/ApexCompanion"},
            ]}
        >
            <p className='text-wrap w-full'>
...
heatmapy.
        ...
        <ProjectContainer
            ...
            tech_stack={["Python"]}
            links={[
                {name: "Github", href:"https://github.com/SerwisKacperek/sk-aio"},
            ]}
        >
            <p className='text-wrap w-full'>
